      ...
      <MediaQuery query="(max-width: 992px)" let:matches>
        ...
        <div class="right {matches ? '' : 'animate__animated'} {animateCont2}" style="--animate-duration: 1000ms; --animate-delay: 200ms">
          <div class="computer-screen">
            <img src="./assets/computer.svg" class="computer-graphic" alt="computer screen with coffee and objects" />
          </div>
        </div>
      </MediaQuery>
    </div>
    <img class="side-dots" src="./assets/side-dots.png" alt="side-dots" aria-hidden />
